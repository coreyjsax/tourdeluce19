...
const tools = {
    ...
    processOrder: function(){
        ...
        let totalDue = (parseInt(formData[19].field_62276956)*(parseInt(25.00)));
        let number = 1;

        formData.push(
            {field_62277012: totalDue},
            {field_62277013: number}
        );
        console.log(formData)

        //need to convert data to query string

        
        
        
        this.submitOrder(formData, '3002951')
    },
